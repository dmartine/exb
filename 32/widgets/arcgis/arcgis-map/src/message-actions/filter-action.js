    ...
    FilterAction.prototype.onExecute = function (message, actionConfig) {
        switch (message.type) {
            case jimu_core_1.MessageType.DataRecordsSelectionChange:
                ...
                if (actionConfig) {
                    if (actionConfig.messageUseDataSource && actionConfig.actionUseDataSource) {
                        if (message.records.length > 0
                            ...
                            jimu_core_1.getAppStore().dispatch(jimu_core_1.appActions.widgetMutableStatePropChange(this.widgetId, 'filterActionValue', null));
                            break;
                        }
                ...
                jimu_core_1.getAppStore().dispatch(jimu_core_1.appActions.widgetMutableStatePropChange(this.widgetId, 'filterActionValue', filterActionValue));
                break;
        }
        return true;
    };
