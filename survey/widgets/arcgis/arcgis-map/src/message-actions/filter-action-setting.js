...
var _FilterActionSetting = /** @class */ (function (_super) {
    __extends(_FilterActionSetting, _super);
    function _FilterActionSetting(props) {
    ...
    _FilterActionSetting.prototype.componentDidMount = function () {
    ...
    _FilterActionSetting.prototype.getStyle = function (theme) {
    ...
    _FilterActionSetting.prototype.render = function () {
        var _this = this;
    ...
    return _FilterActionSetting;
}(jimu_core_1.React.PureComponent));
exports.default = jimu_core_1.themeUtils.withTheme(_FilterActionSetting);
