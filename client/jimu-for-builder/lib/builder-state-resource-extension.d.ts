...
import { ImmutableObject, Immutable, extensionSpec } from 'jimu-core';
...
export default class BuilderStateResourceExtension implements extensionSpec.ReduxStoreExtension {
    ...
    getReducer(): (resourcesInfo: Immutable.ImmutableObject<{
        [resourceKey: string]: Immutable.ImmutableObject<ResourceItemInfo>;
    }>, action: ActionTypes, builderFullState: Immutable.ImmutableObject<import("jimu-core/lib/types/state").State>) => any;
    getStoreKey(): string;
}
