/** @jsx jsx */
import {React, InjectedIntl, jsx, ThemeVariables, themeUtils, AppMode, LayoutItemConstructorProps} from 'jimu-core';
...
export class _PendingElement extends React.PureComponent<Props & {theme: ThemeVariables}, {}>{
...
export const PendingElement = themeUtils.withTheme(_PendingElement);
