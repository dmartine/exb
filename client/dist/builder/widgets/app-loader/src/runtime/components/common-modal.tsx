/** @jsx jsx */
import {React, jsx, css, ThemeVariables, SerializedStyles} from 'jimu-core';
...
export default class CommonModal extends React.PureComponent<props, {isOpen: boolean}>{
  ...
  render(){
    ...
    return(
    <Modal css={this.getStyle()}  modalClassName="toc-add-page-modal" backdropClassName="toc-add-page-modal"
